               ...
               <div class="pb-5 mb-3 px-4 text-center">
                    <div class="container text-justify">
                         <p>Established as a start-up, Vimanam is an aerial photography and filming company based in
                              ...
                              specific needs of our clients.We currently operate in the Chennai area. Businesses outside of a 20 mile radius may require travel expenses. Please contact for more details.</p>
                    </div>
               </div>
               <div class="pb-5 mb-3 px-4 text-center">
                         ...
                         <form action="" class="mt-5 pt-5">
                              <div class="row">
                                   ...
                                   <div class="col-sm-12 col-lg-6 mt-3 mt-lg-0">
                                        ...
                                        <button class="btn btn-primary text-white w-100 mt-4">Submit</button>
                                   </div>
                              </div>
